...
def _suggest_et(trial: optuna.Trial) -> dict:
    """Suggest Extra Trees hyperparameters."""
    return {
...
MODEL_REGISTRY = {
    "ExtraTrees":        (ExtraTreesClassifier, _suggest_et),
}
...
def main():
    ...
    print(f"  Total PNGs: {len(MODEL_REGISTRY) * 2 + 1}")
